...
public record CompleteSignUpRequest(@NotBlank(message = "Signup token is required") String signupToken,
        ...
        @NotBlank(message = "Confirm password is required") String confirmPassword, String fcmToken) {
}
