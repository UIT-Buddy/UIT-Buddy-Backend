...
public enum HomeClassErrorCode {
  ...
  INVALID_ACADEMIC_YEAR(
      "HC_005", "Cannot extract academic year from home class code", HttpStatus.BAD_REQUEST),
  HOME_CLASS_CREATION_FAILED(
      "HC_006", "Failed to create home class", HttpStatus.INTERNAL_SERVER_ERROR);
