...
public enum ExternalClientErrorCode {
    // Connection errors
    CONNECTION_TIMEOUT("CLIENT_001", "Connection timeout to external service", HttpStatus.GATEWAY_TIMEOUT),
    CONNECTION_REFUSED("CLIENT_002", "Connection refused by external service", HttpStatus.BAD_GATEWAY),
    SERVICE_UNAVAILABLE("CLIENT_003", "External service is unavailable", HttpStatus.SERVICE_UNAVAILABLE),

    // Request errors
    BAD_REQUEST("CLIENT_004", "Invalid request to external service", HttpStatus.BAD_REQUEST),
    UNAUTHORIZED_REQUEST("CLIENT_005", "Unauthorized request to external service", HttpStatus.UNAUTHORIZED),
    ...
    UNKNOWN_ERROR("CLIENT_011", "Unknown error occurred while calling external service",
