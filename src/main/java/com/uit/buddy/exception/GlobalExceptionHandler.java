...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleValidationException(
    ...
    String firstError =
        errors.values().stream().findFirst().orElse(SystemErrorCode.VALIDATION_ERROR.getMessage());

    ErrorResponse response =
        new ErrorResponse(
            HttpStatus.BAD_REQUEST.value(), firstError, SystemErrorCode.VALIDATION_ERROR.getCode());
  ...
  public ResponseEntity<ErrorResponse> handleTransactionException(TransactionSystemException ex) {
    ...
    if (cause instanceof BaseException) {
      ...
      ErrorResponse response =
          new ErrorResponse(baseEx.getHttpStatus().value(), baseEx.getMessage(), baseEx.getCode());
