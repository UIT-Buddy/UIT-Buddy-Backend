...
public enum AuthErrorCode {
  ...
  PENDING_ACCOUNT_NOT_FOUND("AUTH_011", "MSSV doens't match WsToken", HttpStatus.NOT_FOUND),
  ...
  OTP_MAX_ATTEMPTS_EXCEEDED(
      "AUTH_019", "Maximum OTP verification attempts exceeded", HttpStatus.TOO_MANY_REQUESTS),
  ...
  PERMISSION_DENIED(
      "AUTH_020", "You do not have permission to perform this action", HttpStatus.FORBIDDEN),

  // External service errors
  EXTERNAL_SERVICE_ERROR(
      "AUTH_018", "External service temporarily unavailable", HttpStatus.SERVICE_UNAVAILABLE);
