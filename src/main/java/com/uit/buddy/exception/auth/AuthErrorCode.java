...
public enum AuthErrorCode {
    ...
    ACCOUNT_LOCKED("AUTH_003", "Account is locked due to too many failed login attempts", 403),
    INVALID_PASSWORD("AUTH_004", "Invalid password", 401),
    ...
    OTP_ALREADY_VERIFIED("AUTH_105", "OTP has already been verified", 400),

    // Registration & Signup
    mssv_ALREADY_EXISTS("AUTH_200", "mssv is already registered", 409),
    EMAIL_ALREADY_EXISTS("AUTH_201", "Email is already registered", 409),
    INVALID_EMAIL_DOMAIN("AUTH_202", "Only @gm.uit.edu.vn email addresses are allowed", 400),
    ...
    TOO_MANY_LOGIN_ATTEMPTS("AUTH_402", "Too many login attempts. Account has been temporarily locked", 429),
