...
public interface PostRepository extends CrudRepository<Post, UUID> {
  ...
  @Query(
      ...
      countQuery =
          ...
          """,
      nativeQuery = true)
  Page<PostFeedProjection> searchPostFull(
      @Param("keyword") String keyword, @Param("mssv") String mssv, Pageable pageable);
  ...
  @Query(
      ...
      """,
      nativeQuery = true)
  List<PostFeedProjection> findFeed(
  ...
  @Query(
      value =
          "SELECT "
              + SELECT_BASE
              + """
      FROM posts p JOIN students s ON p.mssv = s.mssv WHERE p.id = :postId""",
      nativeQuery = true)
  Optional<PostFeedProjection> findDetailWithStatus(
      @Param("postId") UUID postId, @Param("mssv") String mssv);
