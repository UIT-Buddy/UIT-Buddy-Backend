...
public class PostController extends AbstractBaseController {
  ...
  @Operation(
      ...
      description = "Get paginated post feed with cursor-based pagination")
  ...
  @Operation(
      ...
      description = "Get detailed post information with comments and reactions")
  public ResponseEntity<SingleResponse<PostDetailResponse>> getPostDetail(
  ...
  @Operation(
      ...
      description = "Update post title and content (files cannot be updated)")
  ...
  public ResponseEntity<CreatedResponse<Void>> uploadPost(
      @RequestParam("title")
          ...
          @Size(
              min = 1,
              max = 255,
              message = "Title must not exceed 255 characters and at least 1 character")
          String title,
