...
public class AuthController extends AbstractBaseController {
    ...
    public ResponseEntity<SingleResponse<ValidateTokenResponse>> validateToken(
        ...
        log.info("[POST /api/auth/signup/init] Validating Moodle token for signup");
    ...
    @Operation(summary = "Complete Sign Up", description = "Finalize the registration process and create a new student account")
    public ResponseEntity<SingleResponse<AuthResponse>> completeSignUp(
            @Valid @RequestBody CompleteSignUpRequest request) {
        log.info("[POST /api/auth/signup/complete] Completing signup for mssv: {}", request.mssv());
    ...
    public ResponseEntity<SingleResponse<AuthResponse>> signIn(@Valid @RequestBody SignInRequest request) {
        log.info("[POST /api/auth/signin] Signing in for mssv: {}", request.mssv());
    ...
    public ResponseEntity<SuccessResponse> forgetPassword(@Valid @RequestBody ForgetPasswordRequest request) {
        log.info("[POST /api/auth/forget-password] Sending reset OTP for mssv: {}", request.mssv());
    ...
    public ResponseEntity<SuccessResponse> resetPassword(@Valid @RequestBody ResetPasswordRequest request) {
        log.info("[POST /api/auth/reset-password] Resetting password for mssv: {}", request.mssv());
