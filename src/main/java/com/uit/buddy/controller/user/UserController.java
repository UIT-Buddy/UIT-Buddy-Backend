...
public class UserController extends AbstractBaseController {
  ...
  @Operation(
      ...
      description = "Fetch detailed information of the currently authenticated student")
  public ResponseEntity<SingleResponse<UserResponse>> getMyProfile(
  ...
  @Operation(
      ...
      description = "Update specific fields of the user profile such as nickname, avatar, or bio")
  public ResponseEntity<SingleResponse<UserResponse>> updateProfile(
      @AuthenticationPrincipal String mssv, @Valid @RequestBody UpdateUserRequest request) {
  ...
  public ResponseEntity<SingleResponse<String>> uploadAvatar(
      @RequestParam("file") MultipartFile file, @AuthenticationPrincipal String mssv) {
  ...
  @Operation(
      ...
      description = "Register or update FCM token for multi-device support")
  public ResponseEntity<SingleResponse<Void>> syncFcmToken(
      @AuthenticationPrincipal String mssv, @Valid @RequestBody FcmTokenRequest request) {
  ...
  @GetMapping("/{mssv}")
  @Operation(
      summary = "Get other student profile",
      description = "Fetch detailed information of other student")
  public ResponseEntity<SingleResponse<UserResponse>> getOtherStudentProfile(
  ...
  @Operation(
      ...
      description = "Search information of other student with keyword and filter")
