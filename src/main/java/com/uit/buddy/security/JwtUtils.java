...
public class JwtUtils {
    ...
    public String generateToken(Map<String, Object> extraClaims, JwtUserDetails userDetails) {
    ...
    private String buildToken(
        ...
        extraClaims.put("mssv", userDetails.getMssv());
    ...
    public boolean isTokenValid(String token, JwtUserDetails userDetails) {
