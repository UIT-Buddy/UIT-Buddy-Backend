...
public class JwtUtilsImpl implements JwtUtils {
  ...
  public JwtUtilsImpl(
      ...
      @Value("${app.jwt.refresh-token-remember-me-expiration}")
          long refreshTokenRememberMeExpiration,
  ...
  public void revokeAllSessions(String mssv) {
    try {
      ...
      log.error(
          "Failed to revoke sessions using Lua script for MSSV: {}, falling back to repository",
          mssv,
          e);
      refreshTokenRepository.deleteByMssv(mssv);
    }
