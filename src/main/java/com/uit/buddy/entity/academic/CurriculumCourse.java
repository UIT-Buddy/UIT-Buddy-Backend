...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_curr_course_cat",
          columnNames = {"curriculum_code", "course_code", "category_code"})
    },
    indexes = {
...
public class CurriculumCourse extends AbstractBaseEntity {
  ...
  @JoinColumn(
      ...
      referencedColumnName = "curriculum_code",
      foreignKey = @ForeignKey(name = "fk_curr_course_curriculum"))
  ...
  @JoinColumn(
      ...
      foreignKey = @ForeignKey(name = "fk_curr_course_course"))
  ...
  @JoinColumn(
      ...
      foreignKey = @ForeignKey(name = "fk_curr_course_category"))
  ...
  @JoinColumn(
      ...
      referencedColumnName = "course_code",
      foreignKey = @ForeignKey(name = "fk_curr_course_prerequisite"))
