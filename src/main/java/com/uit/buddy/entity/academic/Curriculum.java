...
@Entity
@Table(name = "curriculums", indexes = { @Index(name = "idx_curriculum_major", columnList = "major_code"),
...
public class Curriculum extends AbstractAuditEntity {
    ...
    @JoinColumn(name = "major_code", referencedColumnName = "major_code", foreignKey = @ForeignKey(name = "fk_curriculum_major"))
    private Major major;
