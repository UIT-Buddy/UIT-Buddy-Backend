...
public class FcmConfig {
    ...
    public FirebaseApp firebaseApp() throws IOException {
        return FirebaseApp.getApps().stream().filter(app -> app.getName().equals(appName)).findFirst().orElseGet(() -> {
            try {
                ...
                log.error("[Firebase] Critical: Could not read service account file at {}. Error: {}", configPath,
                        e.getMessage());
